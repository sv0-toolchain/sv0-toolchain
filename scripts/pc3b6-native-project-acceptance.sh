...
fail=0
for fx in modules_enum_match modules_struct_type modules_struct_sig struct_field_pattern modules_diamond modules_generic_carrier \
          uc_loop_sumsq uc_calculator uc_vec2 uc_vec_stack uc_option_sum \
          impl_methods mcall_compound_arg enum_return_let match_guard int_min shadowing nested_struct question_op \
          project_root_entry; do
